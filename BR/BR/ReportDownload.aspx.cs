    ...
    public partial class ReportDownload : System.Web.UI.Page
    {
        ...
        private void AssignSummary(DataTable dtFeedbackReport)
        {
            if(dtFeedbackReport.Rows[0]["ansText"].ToString() == "Yes")
            {
                ...
                if (dtFeedbackReport.Rows[1]["ansText"].ToString() == "Yes")
                {
                    Label2.Enabled = false;
                    Label2_bullet.Enabled = false;
                }
                else
                if (dtFeedbackReport.Rows[1]["ansText"].ToString() == "No")
                {
                    Label2_bullet.Text = "\u25C9";
                ...
                if (dtFeedbackReport.Rows[1]["ansText"].ToString() == "Don't Know")
                {
                    Label2_bullet.Text = "\u25C9";
                    Label2.Text = "Outsourcing the security of your organization to an MSSP helps in reducing the costs and gets benefits like  24x7x365 Security Operation Centers (SOCs) for continous monitoring and rapid response on any incidents by intrusions from advanced attack groups. ";
                }
                if (dtFeedbackReport.Rows[2]["ansText"].ToString() == "Yes")
                {
                    Label3.Enabled = false;
                    Label3_bullet.Enabled = false;
                }
                else
                if (dtFeedbackReport.Rows[2]["ansText"].ToString() == "No")
                {
                    Label3_bullet.Text = "\u25C9";
                ...
                if (dtFeedbackReport.Rows[2]["ansText"].ToString() == "Don't Know")
                {
                    Label3_bullet.Text = "\u25C9";
                    Label3.Text = "An anti virus software in your computer systems protects it from spywares, viruses and scans removable devices of any threats before they can harm your computer systems. Also, it can help by protecting it from phishing attacks, blocking Ads and spam websites.";
                }
                if (dtFeedbackReport.Rows[3]["ansText"].ToString() == "Yes")
                {
                    Label4.Enabled = false;
                    Label4_bullet.Enabled = false;
                }
                else
                if (dtFeedbackReport.Rows[3]["ansText"].ToString() == "No")
                {
                    Label4_bullet.Text = "\u25C9";
                ...
                if (dtFeedbackReport.Rows[3]["ansText"].ToString() == "Don't Know")
                {
                    Label4_bullet.Text = "\u25C9";
                    Label4.Text = "Encryption is a process of converting your information or data to an indecipherable code that can only be decrypted by someone possessing the actual encryption key.You can encrypt data not only which transist on the internet but also data which resides on your computer, hard drives or mobile devices.";
                }
                if (dtFeedbackReport.Rows[4]["ansText"].ToString() == "Yes")
                {
                    Label5.Enabled = false;
                    Label5_bullet.Enabled = false;
                }
                else
                if (dtFeedbackReport.Rows[4]["ansText"].ToString() == "No")
                {
                    Label5_bullet.Text = "\u25C9";
                ...
                if (dtFeedbackReport.Rows[4]["ansText"].ToString() == "Don't Know")
                {
                    Label5_bullet.Text = "\u25C9";
                    Label5.Text = "An Incident response plan includes written instructions on how to respond to an incident like data breaches/Denial of service, network intrusions or malware outbreaks.Incident response plan can help in mitigating the cyber incidents faster and minimize the risks to your business. ";
                }
            ...
            if (dtFeedbackReport.Rows[6]["ansText"].ToString() == "Yes")
            {
                ...
                if (dtFeedbackReport.Rows[7]["ansText"].ToString() == "Yes")
                {
                    Label8_bullet.Text = "\u25C9";
                    Label8.Text = " We found you at low risk for this category. But remember that risk assessment is not a one-time activity, your IT environment and the threat landscape are constantly changing, so remember to perform it on a regular basis.";
                }
                else
                if (dtFeedbackReport.Rows[7]["ansText"].ToString() == "No")
                {
                    Label8_bullet.Text = "\u25C9";
                ...
                if (dtFeedbackReport.Rows[7]["ansText"].ToString() == "Don't Know")
                {
                    Label8_bullet.Text = "\u25C9";
                    Label8.Text = "BCP and DRP have become really crucial when recovering from cyber incidents. These are strategies that the organizations need to carry on while it recovers from disruptions and data loss, caused by a cyber Incident or disaster like earthquake or a major outage.";
                }

                if (dtFeedbackReport.Rows[8]["ansText"].ToString() == "Yes")
                {
                    Label9_bullet.Text = "\u25C9";
                    Label9.Text = " We found you at low risk for this category. But remember that risk assessment is not a one-time activity, your IT environment and the threat landscape are constantly changing, so remember to perform it on a regular basis.";
                }
                else
                if (dtFeedbackReport.Rows[8]["ansText"].ToString() == "No")
                {
                    Label9_bullet.Text = "\u25C9";
                ...
                if (dtFeedbackReport.Rows[8]["ansText"].ToString() == "Don't Know")
                {
                    Label9_bullet.Text = "\u25C9";
                    Label9.Text = "As a best practice it is recommended to be running weekly integrity checks on your backup databases to ensure they are free of corruption. Data backups allow for minimal business interruption and helps mitigating data loss during a security incident";
                }
            ...
            {
                Label7_bullet.Text = "\u25C9";
                Label7.Text = "We found you at low risk for this category. But remember that risk assessment is not a one-time activity, your IT environment and the threat landscape are constantly changing, so remember to perform it on a regular basis.";
            ...
            if (dtFeedbackReport.Rows[18]["ansText"].ToString() == "Yes")
            {
                ...
                if (dtFeedbackReport.Rows[20]["ansText"].ToString() == "Yes")
                {
                    Label21_bullet.Text = "\u25C9";
                    Label21.Text = " We found you at low risk for this category. But remember that risk assessment is not a one-time activity, your IT environment and the threat landscape are constantly changing, so remember to perform it on a regular basis.";
                }
                else
                if (dtFeedbackReport.Rows[20]["ansText"].ToString() == "No")
                {
                    Label21_bullet.Text = "\u25C9";
                ...
                if (dtFeedbackReport.Rows[20]["ansText"].ToString() == "Don't Know")
                {
                    Label21_bullet.Text = "\u25C9";
                    Label21.Text = "Without a proper file processing system in place, employees will resort to storing client and company information locally on their computing devices. In the event of a compromise, this puts the organization and its client at risk";
                }
            ...
            {
                Label19_bullet.Text = "\u25C9";
                Label19.Text = " We found you at low risk for this category. But remember that risk assessment is not a one-time activity, your IT environment and the threat landscape are constantly changing, so remember to perform it on a regular basis.";
                Label20_bullet.Enabled = false;
                Label20.Enabled = false;
                Label21_bullet.Enabled = false;
            ...
            {
                Label23_bullet.Text = "\u25C9";
                Label23.Text = "We found you at low risk for this category. But remember that risk assessment is not a one-time activity, your IT environment and the threat landscape are constantly changing, so remember to perform it on a regular basis.";
            }
            ...
            {
                Label24_bullet.Text = "\u25C9";
                Label24.Text = "We found you at low risk for this category. But remember that risk assessment is not a one-time activity, your IT environment and the threat landscape are constantly changing, so remember to perform it on a regular basis.";
            }
